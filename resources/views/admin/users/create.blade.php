...
@section('subcontent')
	<div class="flex items-center mt-8">
		<h2 class="intro-y text-lg font-medium mr-auto">New user</h2>
	</div>

	<form action="{{ route('admin.user.create') }}" method="POST" enctype="multipart/form-data" class="intro-y box py-10 sm:py-20 mt-5" id="wizard">
        @csrf
		<div class="top-navigation nav-tabs">
			...
			<a id="address-tab" data-toggle="tab" data-target="#address" href="#address" class="item">
        ...
        <div class="tab-content">
                    ...
                    <div class="flex flex-col md:flex-row gap-y-8 md:gap-y-0 md:gap-x-8 mt-5">
                        ...
                        <div class="grid grid-cols-12 gap-2 w-full">
                            ...
                            <div class="col-span-12 md:col-span-6">
                                ...
                                {{ Form::select('departments[]', $departments, null, ['class' => 'tail-select w-full mt-1', 'id' => 'departments', 'multiple']) }}
                            </div>
                            <div class="col-span-12">
                                {{ Form::textAreaGroup('description', null, 'Description', ['placeholder' => '...']) }}
                            </div>
                            <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                                <button type="button" data-toggle="click" data-target="#address-tab" class="btn btn-primary w-24 ml-2">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="address" class="tab-pane" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5">
                    ...
                    <div class="grid grid-cols-12 gap-2 mt-3">
                        ...
                        <div class="intro-y col-span-12 flex items-center justify-center sm:justify-end mt-5">
                            <button type="button" data-toggle="click" data-target="#personal-tab" class="btn btn-secondary w-24 ml-2">Previous</button>
            ...
            <div id="billing" class="tab-pane" role="tabpanel" aria-labelledby="dashboard-tab">
                <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-gray-200 dark:border-dark-5">
                    ...
                    <div class="grid grid-cols-12 gap-2 mt-3">
                        <div class="col-span-12">
                            {{ Form::textGroup('iban', null, 'IBAN', ['class' => 'form-control']) }}
                        </div>
                        <div class="col-span-12 md:col-span-6">
